...
export const AXES: { axis: string; match: RegExp; note: string }[] = [
  ...
  { axis: "중국", match: /중국반도체|SMIC|YMTC|CXMT|중국|BYD|희토류/, note: "판가·가격 경쟁, 수출통제 — 반도체·자동차 마진" },
  { axis: "자사주", match: /자사주|자기주식|소각|주주환원|밸류업/, note: "주주환원 — 해당 종목 수급 직접 재료" },
  { axis: "예정이벤트", match: /예정이벤트/, note: "아직 안 일어난 일정 — 발표 전 포지션 축소 근거" },
