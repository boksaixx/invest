...
- 주제 3(반도체 업황) 최소 3건, 주제 4~5(매크로·지수·파생) 최소 4건, 주제 7(지정학·전쟁) 최소 2건, 주제 8(미국 정책) 최소 2건, 주제 9(중국) 최소 2건, 주제 10(자사주) 최소 1건, 주제 11(예정 이벤트) 최소 2건, 주제 12~13(큰손·실적 전망) 합쳐 최소 2건을 반드시 채운다. 해당 주제에 최신 뉴스가 정말 없으면 그 사실을 impact "낮음"으로라도 1건 남긴다.
...
[{"title":"","summary":"","sentiment":"긍정"|"부정"|"중립","impact":"높음"|"중간"|"낮음","relatedTo":"삼성전자"|"SK하이닉스"|"한미반도체"|"삼성전기"|"DB하이텍"|"한화에어로스페이스"|"현대차"|"KB금융"|"셀트리온"|"KT"|"반도체업황"|"매크로"|"지수"|"레버리지ETF"|"파생시장"|"지정학"|"미국정책"|"중국"|"중국반도체"|"자사주"|"예정이벤트"|"큰손동향"|"실적전망","topic":"자사주"|"중국"|"미국정책"|"관세"|"전쟁지정학"|"금리환율"|"실적"|"업황"|"수급"|"지수"|"예정이벤트"|"기타","eventAt":"(예정이벤트만, KST 시각)","eventInHours":(예정이벤트만, 숫자),"source":"","publishedAt":"","isBreaking":true|false}]`;
