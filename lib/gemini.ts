...
3. 반도체 업황: D램/낸드/HBM 가격·수요, TSMC·마이크론·AI 반도체 수요 뉴스 — 로이터/블룸버그/CNBC 등 외신 원문이 있으면 국내 번역기사보다 우선 채택(번역 시차만큼 늦기 때문). 국내 기사만 있으면 그것을 쓰되 원문 시각 기준으로 판단
4. 매크로: 원/달러 환율 급변동, 미 연준(Fed) 금리/CPI 발언, 국제 유가(WTI) 급등락 — 이것도 외신 원문 발표 시각을 우선 기준으로 삼는다, 코스피·나스닥 수급
