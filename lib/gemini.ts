...
구글 검색으로 아래 주제들에 대한 "지금 이 순간" 기준 최신 정보를 최대한 폭넓고 꼼꼼하게 확인하세요. 유료 등급 사용량을 쓰고 있으니 검색 횟수를 아끼려고 항목을 생략하지 말고, 각 주제마다 실제로 검색해 근거를 충분히 확보하세요. 다만 검색해도 실제로 결과가 없는 항목은 지어내지 말고 비워두세요:
