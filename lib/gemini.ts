...
5. 파생시장: 코스피200 선물 수급, 나스닥 선물, VIX·공포탐욕지수
...
[{"title":"","summary":"","sentiment":"긍정"|"부정"|"중립","impact":"높음"|"중간"|"낮음","relatedTo":"삼성전자"|"SK하이닉스"|"한미반도체"|"삼성전기"|"DB하이텍"|"엔비디아"|"반도체업황"|"매크로"|"레버리지ETF"|"파생시장"|"지정학","source":"","publishedAt":"","isBreaking":true|false}]`;
