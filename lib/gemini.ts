...
7. 지정학·정치: 미중 갈등, 반도체 수출규제·관세, AI 규제 이슈, 트럼프 등 미국 주요 정치인의 관세·반도체 관련 발언(발언 자체가 시장을 바로 움직이므로 발언 시각과 원문 인용 우선), 중동/이란 정세와 유가·해운 영향
9. 중국 반도체 동향: SMIC·YMTC·CXMT 등 중국 업체의 증설·수율·기술 돌파, 중국의 메모리 저가 공세(국내 업체 판가 압박), 중국 정부 보조금·자급률 정책. 국내 반도체주에 직접 타격을 주는 축이라 별도로 챙긴다
10. 큰손 투자자 동향: 마이클 버리·워런 버핏·손정의 등 저명 투자자의 반도체/AI 관련 포지션 공시(13F)·공개 발언·공매도, 국내 연기금·국부펀드의 대형 매매. "누가 반대편에 서 있는가"는 과열/침체 판단의 보조 근거가 된다
11. 실적 전망: 추적 10종목과 TSMC·마이크론·ASML의 가이던스 상향/하향, 컨센서스 변화, 어닝 서프라이즈/쇼크
