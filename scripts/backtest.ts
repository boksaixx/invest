    ...
    JSON.stringify(
      {
        ...
        disclaimer:
          "3개년 일봉 종가 기준 단순 재현 통계입니다. 장중 변동성·뉴스·매크로 이벤트는 과거 시점으로 재현할 수 없어 제외했으며, 실제 체결가·슬리피지·거래비용도 반영하지 않았습니다. 과거 승률이 미래 수익을 보장하지 않습니다 — 참고 지표로만 사용하세요.",
